            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-left">
                        <li class="nav-item"><a href="{{ url('/articles') }}" class="nav-link">Articles</a>
                        </li>
                        <li class="nav-item"><a href="{{ url('/games') }}" class="nav-link">Games</a>
                        </li>
                        <li class="nav-item"><a href="{{ url('/members') }}" class="nav-link">Members</a>
                        </li>
                    </ul>
                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @if (Auth::user()->isRole('ADMIN') == 'ADMIN')
                                        <li>
                                            <a href="{{ url('/admin') }}">
